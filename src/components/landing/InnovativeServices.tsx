...
const services = [
  {
    ...
    description:
      "Комплексный осмотр, сбор анамнеза и постановка диагноза опытными терапевтами. Индивидуальный подход к каждому пациенту.",
    mockup: "social",
  },
  {
    title: "Педиатрия",
    description:
      "Наблюдение детей с рождения, плановые осмотры, вакцинация и лечение. Добрые врачи, которым доверяют и дети, и родители.",
    mockup: "google-ads",
  },
  {
    title: "Онлайн-консультации",
    description: "Получите консультацию врача не выходя из дома. Удобно, быстро и безопасно — через видеосвязь или чат.",
    mockup: "email",
  },
  {
    title: "Профилактика",
    description:
      "Программы профилактических обследований для всей семьи. Выявляем риски заранее и помогаем сохранить здоровье.",
    mockup: "seo",
  },
  {
    title: "Лабораторные анализы",
    description:
      "Широкий спектр лабораторных исследований с быстрым получением результатов онлайн. Точно и в срок.",
    mockup: "analytics",
  },
  {
    title: "Семейный врач",
    description:
      "Персональный врач для всей семьи. Знает историю болезни каждого, всегда на связи и готов помочь при любом обращении.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Конфиденциально" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Без скрытых сборов" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Лицензировано" },
    ],
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Полный спектр медицинских консультаций для здоровья каждого члена вашей семьи.
          </p>
        </motion.div>
